...
실제 round의 최대 로컬 추정6,538 tokens, 최대 provider 입력4,857 tokens, 최대 bytes25,619(서로 다른 요청의 최대값)가 관측됐다. 오프라인 대표 최대는20,322 tokens/84,295 bytes였다. 용량 실패는 없었다. v2는48,000/192 KiB를 유지하고 별도 축소/확대 최적화를 하지 않는다. 기존 검사에서 새 대표 입력을 측정하고 부족할 때만 위 사전 조정 정책을 적용한다.
