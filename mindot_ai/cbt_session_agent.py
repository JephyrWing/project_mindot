...
from cbt_q11.contracts import CbtAgentIdempotencyError
from cbt_simple.service import close, generate, registry as _registry
from cbt_q11.state import SessionRegistry

CBT_AGENT_PROMPT_VERSION = 'simple-dialogue-2'
