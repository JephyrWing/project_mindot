...
def main():
    ...
    suites = {
        'ai': ([[sys.executable,'-m','unittest','discover','-s','tests','-p','test_insight_protocol.py'],
                ...
                [sys.executable,'-m','unittest','discover','-s','tests','-p','test_q13_thought_change.py'],
                [sys.executable,'-m','unittest','discover','-s','tests','-p','test_q14_current_thought_check.py']], ROOT/'mindot_ai'),
