"""Normative schemas for simple-dialogue-2; not a product implementation.
...
CONTRACT_REVISION = "simple-dialogue-2"
...
TOOL_DESCRIPTIONS = {
    "write_turn": "지금 사용자가 답할 구체적인 CBT 질문 목표 하나를 선택한다. 중단 안내나 문서 작성은 이 도구가 아니다.",
    "present_pending_question": "실제 CBT 질문 하나에 대한 예시 또는 설명 요청을 이행한다.",
    "assess_completion": "현재 자료로 원래 자동사고를 평가할 때 Assessor 후보를 요청한다. 네 영역 채움이나 사용자 초안 명령을 요구하지 않는다.",
    "respond_control": "성찰을 그만하겠다는 의사는 STOP으로 기존 중단 안내를 제공한다. 그 밖에는 실제 대상·진행 방향 확인·대기 안내를 제공한다.",
